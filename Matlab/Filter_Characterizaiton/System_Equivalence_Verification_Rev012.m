...
%%% filter with a repeating pn code but constant data to further reduce ISI
%%% due to filter impulse response ring out.  There will still be minimal
%%% ISI as the code prior and posterior to the code being correlated will
%%% bleed energy into the code since it is a short code in relation to the
...
PN_Length = 2^17; symbol_pn_size = 2^6;
